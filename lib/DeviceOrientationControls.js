...
THREE.DeviceOrientationControls = function( object ) {
	...
	//gets real world north direction to offset alpha
	...
	this.connect = function() {
		...
		window.addEventListener( 'deviceabsoluteorientation', onDeviceOrientationAbsoluteChangeEvent, true );
	...
	this.disconnect = function() {
		...
		window.removeEventListener( 'deviceabsoluteorientation', onDeviceOrientationAbsoluteChangeEvent, true );
	...
	this.updateAlphaOffsetAngle = function( angle ) {
		console.log(angle)
		this.alphaOffsetAngle = THREE.Math.degToRad(360-angle);
		this.update();
